...
import DataModel from "../models/points";
import {  Wilayah } from '../models';
                            ...
                            include: [
                              {
                                model: Wilayah,
                                as: 'wilayah',
                                attributes: ['id', 'title'] // field apa aja yg mau ditampilkan
                              }
                            ]
                          });
